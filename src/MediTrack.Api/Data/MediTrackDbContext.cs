...
public class MediTrackDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Appointment>().HasData(
            new Appointment { Id = 1, PatientId = 1, DoctorId = 1, AppointmentDateTime = new DateTime(2025, 1, 15, 9, 0, 0, DateTimeKind.Utc), Reason = "Annual checkup", Status = AppointmentStatus.Completed, CreatedAt = new DateTime(2025, 1, 10, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 1, 0, 0, 0, 0, 0, 0, 0 } },
            new Appointment { Id = 2, PatientId = 2, DoctorId = 2, AppointmentDateTime = new DateTime(2025, 2, 20, 10, 30, 0, DateTimeKind.Utc), Reason = "Heart palpitations", Status = AppointmentStatus.Completed, CreatedAt = new DateTime(2025, 2, 15, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 2, 0, 0, 0, 0, 0, 0, 0 } },
            new Appointment { Id = 3, PatientId = 1, DoctorId = 2, AppointmentDateTime = new DateTime(2025, 12, 10, 14, 0, 0, DateTimeKind.Utc), Reason = "Follow-up cardiology", Status = AppointmentStatus.Scheduled, CreatedAt = new DateTime(2025, 11, 1, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 3, 0, 0, 0, 0, 0, 0, 0 } },
            new Appointment { Id = 4, PatientId = 3, DoctorId = 3, AppointmentDateTime = new DateTime(2025, 12, 15, 11, 0, 0, DateTimeKind.Utc), Reason = "Skin rash evaluation", Status = AppointmentStatus.Scheduled, CreatedAt = new DateTime(2025, 11, 5, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 4, 0, 0, 0, 0, 0, 0, 0 } },
            new Appointment { Id = 5, PatientId = 2, DoctorId = 1, AppointmentDateTime = new DateTime(2025, 12, 20, 8, 30, 0, DateTimeKind.Utc), Reason = "Flu symptoms", Status = AppointmentStatus.Scheduled, CreatedAt = new DateTime(2025, 12, 1, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 5, 0, 0, 0, 0, 0, 0, 0 } },
            new Appointment { Id = 6, PatientId = 1, DoctorId = 4, AppointmentDateTime = new DateTime(2025, 3, 5, 15, 0, 0, DateTimeKind.Utc), Reason = "Knee pain", Status = AppointmentStatus.Cancelled, CreatedAt = new DateTime(2025, 2, 20, 0, 0, 0, DateTimeKind.Utc), RowVersion = new byte[] { 6, 0, 0, 0, 0, 0, 0, 0 } }
        );
    }
}
